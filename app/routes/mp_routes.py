...
Endpoints:
    ...
    GET  /api/mps/<name>/criminal    - criminal record of MP
...
from app.services.criminal_services import get_criminal_record
...
# CRIMINAL ROUTE (IMPORTANT: must come before /mps/<name>)
@mp_bp.route("/mps/<string:name>/criminal", methods=["GET"])
def mp_criminal(name):

    record = get_criminal_record(name)
